-- p31b: 인원수에 비례하는 쿠폰 할인(per_head) 추가
--
-- ⚠️ 번호가 p31b 인 이유: 같은 날 다른 작업의 p31_theme_categories_description 과
--    번호·타임스탬프가 모두 겹쳐 있었다. 테스트에 먼저 적용된 쪽(07:50)이 p31 을
--    유지하고, 나중 적용된(08:06) 이쪽에 letter suffix 를 붙여 정리했다.
--
-- 왜 필요한가
