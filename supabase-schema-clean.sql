-- ⚠️ 이 파일은 낡았다. 사용하지 말 것 (2026-09-10).
-- ⚠️ v13 무렵에서 갱신이 멈췄고 session_type · sms_templates · 협찬/페이백 등이
-- ⚠️ 전혀 반영돼 있지 않다. 현재 스키마는 supabase/schema.sql 을 보라.
...
('0829-dating', '2026-08-29', 'evening', '8/29(토) 저녁 · 바-ㅇ탈출(ver.소개팅)', '바-ㅇ탈출(ver.소개팅)',
  '2026-08-29T19:00:00+09:00', '2026-08-29T23:30:00+09:00',
  '서울 신림역 인근',
