...
const SOCIAL_LINKS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current sm:h-8 sm:w-8 lg:h-10 lg:w-10">
  ...
  return (
    <SceneShell local={local} reduceMotion={reduceMotion} index={index} isFirst={isFirst} isLast={isLast}>
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-8 text-center">
        <PointerFillButton href="/notice" className="sm:px-7 sm:py-3.5 sm:text-base lg:px-8 lg:py-4 lg:text-lg">
          공지사항 보러가기 →
        </PointerFillButton>
