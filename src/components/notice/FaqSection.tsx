...
const FAQS = [
  { q: "혼자 또는 친구와 신청해도 되나요?", a: "현재 소개팅 방탈출은 1인 개별 신청만 가능하며, 그룹 방탈출은 혼자 또는 친구와 함께 모두 가능합니다." },
  { q: "언제 참여가 확정되나요?", a: "입금 확인 시 참여가 확정되며, 참여 확정 안내를 신청자(그룹 신청 시 대표 신청자) 번호로 문자 발송드립니다." },
  { q: "방탈출을 못 해봤는데 참여할 수 있나요?", a: "저희는 방탈출을 입문하기 쉽도록 난이도를 초보자도 즐길 수 있는 수준으로 구성하려 노력하고 있습니다." },
