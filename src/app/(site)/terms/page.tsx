    ...
    <div className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground">
              ...
              <ol className="ml-4 list-decimal space-y-2 text-muted">
                ...
                <li className="space-y-1">
                  ...
                  <ul className="ml-4 list-disc space-y-1 text-muted">
                    ...
                    <li>제9조의 참가 연령 기준에 부합하지 않는 신청 등 참가 자격에 부합하지 않는 경우</li>
        ...
        <div className="border-b border-border/40 pb-6">
          ...
          <ol className="ml-4 list-decimal space-y-2 text-muted">
            <li className="space-y-1">
              <p>오프라인 행사의 참가 연령은 해당 회차의 종료 시각을 기준으로 다음과 같이 구분합니다. 회차별 종료 시각은 신청 페이지에 명시합니다.</p>
              <ul className="ml-4 list-disc space-y-1 text-muted">
                <li>종료 시각이 22:00 이전인 회차: 만 16세 이상</li>
                <li>종료 시각이 22:00 이후인 회차: 만 19세 이상</li>
              </ul>
            </li>
            <li>만 19세 미만인 자가 오프라인 행사에 참가하는 경우, 신청 시 법정대리인의 동의를 받아야 합니다. 회사는 동의 여부를 확인할 수 있는 절차를 두며, 동의가 확인되지 않는 경우 참가가 제한될 수 있습니다.</li>
            <li>만 19세 미만 참가자가 포함된 회차에서는 주류를 제공하지 않으며, 참가자의 주류 반입도 허용하지 않습니다.</li>
            <li>회사는 현장에서 신분증을 통해 참가 연령을 확인할 수 있으며, 확인 결과 해당 회차의 참가 연령 기준에 미달하는 경우 제6조 4항에 따라 처리합니다.</li>
            <li>온라인 웹방탈출 서비스는 연령 제한 없이 이용할 수 있습니다. 다만 만 14세 미만 이용자가 온라인 서비스를 이용하며 개인정보를 제공하는 경우 법정대리인의 동의가 필요하며, 회사는 이를 확인할 수 있는 절차를 둡니다.</li>
          </ol>
        </div>
