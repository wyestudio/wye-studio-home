                ...
                <table className="w-full border border-border text-xs sm:text-sm">
                  <thead>
                    <tr className="bg-surface">
                      ...
                      <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">수집 목적</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">이름</td>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약 관리 및 현장 이용자 확인</td>
                    </tr>
                    <tr>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">연락처</td>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약 확인 및 이용 안내</td>
                    </tr>
                    <tr>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약 정보(예약 일시, 예약 인원, 이용 콘텐츠)</td>
                    ...
                    <tr>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">방탈출 이용 경험 횟수</td>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">서비스 개선 및 이용 분석</td>
                    </tr>
                    <tr>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">입금자명, 환불 계좌번호</td>
                      <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">결제 확인 및 환불 처리</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <table className="w-full border border-border text-xs sm:text-sm">
              <thead>
                <tr className="bg-surface">
                  ...
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">보유 기간</th>
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">보유 근거</th>
                </tr>
              </thead>
              <tbody className="text-muted">
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약자·참여자 정보(이름, 연락처, 성별, 출생년도, 닉네임, 이용 경험 횟수 등)</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">행사 종료 후 5년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">고객관리 및 재방문 서비스 목적 (관련 계약·결제 기록 보유기간과 동일하게 적용)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">5년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">전자상거래 등에서의 소비자보호에 관한 법률(대금결제 기록과 동일 적용)</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">노쇼·블랙리스트 관리 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">행사일로부터 2년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">부정 예약 방지 목적</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">계약 또는 청약철회 등에 관한 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">5년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">전자상거래 등에서의 소비자보호에 관한 법률</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">대금결제 및 재화 등의 공급에 관한 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">5년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">전자상거래 등에서의 소비자보호에 관한 법률</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">소비자의 불만 또는 분쟁처리에 관한 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">3년</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">전자상거래 등에서의 소비자보호에 관한 법률</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">표시·광고에 관한 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">6개월</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">전자상거래 등에서의 소비자보호에 관한 법률</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">접속 로그 기록</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">3개월</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">통신비밀보호법</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">마케팅 정보 제공 동의 정보</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">동의 철회 시까지</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">정보주체 동의</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table className="w-full border border-border text-xs sm:text-sm">
              <thead>
                <tr className="bg-surface">
                  ...
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">위탁 업무 내용</th>
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">처리 정보</th>
                </tr>
              </thead>
              <tbody className="text-muted">
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">솔라피(Solapi)</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약 안내 문자 발송</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">예약 대표자 연락처 및 문자 발송 내용</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table className="w-full border border-border text-xs sm:text-sm">
              <thead>
                <tr className="bg-surface">
                  ...
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">이전 국가</th>
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">이전 항목</th>
                  <th className="border border-border px-3 py-2 text-left font-semibold sm:px-4 sm:py-2.5">이전 목적 및 보유기간</th>
                </tr>
              </thead>
              <tbody className="text-muted">
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">Google LLC (Google Analytics 4)</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">미국</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">방문 페이지, 이용 기록, 접속 경로</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">홈페이지 이용 분석 / 해당 서비스 정책에 따름</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">Meta Platforms, Inc. (Meta Pixel)</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">미국</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">방문 페이지, 광고 성과 관련 정보</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">광고 효과 분석 / 해당 서비스 정책에 따름</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">Microsoft Corporation (Microsoft Clarity)</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">미국</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">이용 기록, 페이지 이용 행태</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">서비스 개선 / 해당 서비스 정책에 따름</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table className="w-full border border-border text-xs sm:text-sm">
              <tbody className="text-muted">
                <tr>
                  ...
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">김시온</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 font-semibold sm:px-4 sm:py-2.5">직책</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">대표</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 font-semibold sm:px-4 sm:py-2.5">전화</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">070-5236-4797</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-2 font-semibold sm:px-4 sm:py-2.5">이메일</td>
                  <td className="border border-border px-3 py-2 sm:px-4 sm:py-2.5">wouldyouescape@gmail.com</td>
                </tr>
              </tbody>
            </table>
          </div>
